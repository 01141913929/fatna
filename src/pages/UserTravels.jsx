      ...
      // بعد نجاح الحفظ في Firestore، قم باستدعاء Netlify Function
       try {
        ...
        const notificationPayload = {
          ...
          imageUrl: vehicle?.imageUrl || 'https://orionmagazine.org/wp-content/uploads/2015/09/8589130570139-dusk-camel-pyramids-cairo-egypt-top-travel-lists-wallpaper-hd.jpg', // <-- إضافة رابط صورة للمركبة
        };
